...
export default function Landing() {
  return (
    <header className={`h-[calc(100vh-70px)]`}>
      <div className={styles.gradientBall}></div>
      <div className={styles.gradientBall2}></div>
      <div className="h-[100%] flex flex-col  justify-center  items-center  max-w-[1050px] mx-auto">
        <h1
          className={`text-5xl text-black   font-bold ${montserrat.className} text-center leading-[120%] mb-5 }`}
        >
          Instantly Embrace the Adoption of a Loving
          <span className={styles.catTitle}> cat</span> into Your Life
        </h1>
        <p
          className="max-w-[650px] mx-auto text-black text-center mb-8
         leading-[200%] "
        >
        ...
        <div>
          ...
          <Link
            href="#"
            className="bg-white px-5 py-3 rounded-full text-black hover:opacity-80"
          >
            Demo
          </Link>
        </div>
